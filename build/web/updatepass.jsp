                ...
                <div id="acc_set">
                    <form name="frm1" action="uppass" method="post">
                      ...
                      <tr><td width="20%" align="left" style="padding-bottom: 14px;"><h3>NAME :</h3></td><td width="84%" align="left" style="padding-bottom: 14px;"><h3><% out.println("<b>"+(String)s.getAttribute("username")+"</b>"); %></h3></td><th><th><th><th></th><td><a href="updatename.jsp"><img src="edit.png" height="30" width="55"/></a></td></tr>
                        ...
                        <tr><td width="20%" align="left" ><h3>PASSWORD :</h3></td><td width="73%" align="left"><input style="background-color: inherit; border-color: black; color: black; font-size: 5;font-weight: bold" type="password" name="pass" /></td></tr>
                        <tr><td width="20%" align="left" ><h3>RE-ENTER PASSWORD :</h3></td><td width="79%" align="left"><input style="background-color: inherit; border-color: black; color: black; font-size: 5;font-weight: bold" type="password" name="re_pass"/></td></tr>
