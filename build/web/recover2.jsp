            ...
            <div id="recover">
                ...
                <form name="frm0" method="post" action="rec2">
                    <table align="left"><% HttpSession s=request.getSession(true);%>
                        <tr><th><h3>Password Recovery Question :</h3><th><h3><% out.println(s.getAttribute("ques")); %></h3></th></tr>
                        <%for(int i=1;i<5;i++){%><tr><%}%><td align="left"><h3>Enter Your Answer :</h3></td><td align="left"><input style="background-color:transparent;border-color: black; color: black" class="inputfield" name="answer" type="text"/></td></tr>
                        <% for(int i=0;i<30;i++){%><tr></tr><%}%>   </table>
