        ...
        <%@include file="menu.html" %>
                <div id="content">
                    <div id="acc_set">
                        ...
                        <form name="frm1" action="upname" method="post">
                            <table>
                            <tr><td width="20%" align="left" style="padding-bottom: 14px;"><h3>NAME :</h3></td><td width="62%" align="left" style="padding-bottom: 14px;"> <textarea style="background-color: inherit; border-color: black; color: black; font-size: 5;font-weight: bold" rows="1" cols="30" name="name"></textarea></td></tr>
                            ...
                            <tr><td width="20%" align="left" style="padding-bottom: 14px;"><h3>PASSWORD :</h3></td><td width="70%" align="left" style="padding-bottom: 14px;"><h3><% out.println("<b>"+(String)s.getAttribute("pass")+"</b>"); %></h3></td><th><th><th><th></th><th align="right"><a href="updatepass.jsp"><img src="edit.png" height="30" width="55"/></a></th></tr>
