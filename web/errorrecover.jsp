            ...
            <div id="recover">
                <div id="text4">Password Recovery Steps</div>
                    <form name="frm0" method="post" action="rec1">
                        <table align="left">
                            <tr><td width="35%" align="left"><h3>Enter your Email ID :</h3></td><td width="35%" align="left"><input type="text" name="email" style="background-color:transparent;border-color: black; color: black" class="inputfield"/></td><td>email-id did not match</td></tr>            
